...
public class TwitterInteraction {
	...
	TwitterInteraction() {
		...
		try {
			...
			cb.setDebugEnabled(true).setOAuthConsumerKey("R1mRJDMvqub0GOU3KAq95x4l0") //API Key here
					.setOAuthConsumerSecret("wpBMQHVKaLe3G76D8As5GLqnldAP9V4Bu97ED9zs0S4s18MtNU") //Secret key here
					.setOAuthAccessToken("1308462582089551877-kb973QwKqXnTUnhDzb3JWL4m5ILqcK") //access token here
					.setOAuthAccessTokenSecret("dNoJsmTM6OmuhGDz5G3XTZuJKlw7lKdfhoAuluhgJw8t1"); //secret access token here
